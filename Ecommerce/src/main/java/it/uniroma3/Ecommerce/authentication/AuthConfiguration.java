...
//                 .requestMatchers("/**").permitAll()
				...
				.requestMatchers(HttpMethod.GET, "/", "/index", "/register", "/css/**", "/images/**", "favicon.ico","/carrello","/prodotto/**","/userProfile/**").permitAll()
				// chiunque (autenticato o no) può mandare richieste POST al punto di accesso
				// per login e register
				.requestMatchers(HttpMethod.POST, "/register", "/login", "/company/showCreateProduct","/prodotto/**","/","/index","/userProfile").permitAll()
